...
from auto_calib_I2I_vectorized import AutoCalibration
...
# gt_params = {'x': -0.071, 'y': 0.093, 'z': -0.032, 'roll_deg': 90.566,'pitch_deg': 0.084, 'yaw_deg': 90.225}
...
calib = AutoCalibration(images, pointclouds, gt_params, config, gt_params=gt_params, params_grid=params_grid)
...
calib = AutoCalibration(images, pointclouds, init_params, config, gt_params=gt_params, params_grid=params_grid)
